...
export type {InvoicePreviewProps, PreviewLineItem} from '@/components/tools/invoice/invoicePreviewShared'
export {INVOICE_PREVIEW_HEIGHT_PX, INVOICE_PREVIEW_WIDTH_PX} from '@/components/tools/invoice/invoicePreviewShared'
export type {InvoicePreviewTemplate} from '@/components/tools/invoice/invoicePreviewShared'
...
function InvoicePreviewClassic({
  fromLines,
  billedLines,
  invoiceDateIso,
  invoiceNo,
  ...
  return (
    <div
      className="invoice-pdf-root shrink-0 overflow-hidden text-black"
      style={{
