...
export default function Section({ sectionTitle, blocks, sectionId, featuredImage }: SectionProps) {
  return (
    <div id={sectionId} className="w-full flex flex-col gap-[24px] items-start">
      <div className="flex items-center w-screen -ml-[2.5%] sm:ml-0 sm:w-full py-[3px]" style={{ backgroundColor: 'var(--section-strip-bg)' }}>
        <p className="font-normal leading-[20px] not-italic text-[13px] text-foreground pl-[5%] sm:pl-[24px]">
          {sectionTitle}
        </p>
      </div>
