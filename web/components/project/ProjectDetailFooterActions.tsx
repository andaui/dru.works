...
const actionClass =
  "relative shrink-0 z-50 pointer-events-auto transition-colors text-[14px] leading-[19px] not-italic font-plex text-black/50 dark:text-white/50 hover:text-accent bg-transparent border-0 p-0 m-0 cursor-pointer";
