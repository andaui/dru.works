...
export default function HomeFooterClock() {
  ...
  return (
    <div className="flex flex-col w-full md:w-auto md:max-w-none max-w-[490px]">
      <svg
        width={490}
        height={490}
        viewBox="0 0 490 490"
        className="shrink-0 w-full max-w-[490px] h-auto"
        role="img"
      ...
      <div className="mt-[66px] pl-[8px] flex flex-col md:flex-row items-start gap-[32px] md:gap-[174px] font-soehne font-normal text-[18px] sm:text-[20px] leading-[26px] sm:leading-[27px] tracking-[-0.25px] text-foreground">
        <div className="whitespace-nowrap w-[150px] shrink-0 flex gap-[16px]">
          <span>LON</span>
