...
export default function ListItems({ items, showBullets = false }: ListItemsProps) {
  if (showBullets) {
    return (
      <div className="flex flex-col gap-[4px] items-start leading-[19px] text-[#5d5d5d] dark:text-[#a3a3a3] text-[13px] w-full">
  ...
  return (
    <div className="flex flex-col gap-[4px] items-start leading-[19px] text-[#5d5d5d] dark:text-[#a3a3a3] text-[13px] text-nowrap">
      {items.map((item, index) => (
